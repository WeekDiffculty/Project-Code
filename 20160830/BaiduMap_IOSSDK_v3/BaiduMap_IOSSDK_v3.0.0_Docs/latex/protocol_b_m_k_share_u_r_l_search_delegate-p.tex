...
B\+M\+K\+Search\+Error\+Code 
\end{DoxySeeAlso}
\hypertarget{protocol_b_m_k_share_u_r_l_search_delegate-p_a04fa292234fc3f9cdc03917291cb9256}{}\index{B\+M\+K\+Share\+U\+R\+L\+Search\+Delegate-\/p@{B\+M\+K\+Share\+U\+R\+L\+Search\+Delegate-\/p}!on\+Get\+Route\+Plan\+Share\+U\+R\+L\+Result\+:result\+:error\+Code\+:@{on\+Get\+Route\+Plan\+Share\+U\+R\+L\+Result\+:result\+:error\+Code\+:}}
\index{on\+Get\+Route\+Plan\+Share\+U\+R\+L\+Result\+:result\+:error\+Code\+:@{on\+Get\+Route\+Plan\+Share\+U\+R\+L\+Result\+:result\+:error\+Code\+:}!B\+M\+K\+Share\+U\+R\+L\+Search\+Delegate-\/p@{B\+M\+K\+Share\+U\+R\+L\+Search\+Delegate-\/p}}
\subsubsection[{on\+Get\+Route\+Plan\+Share\+U\+R\+L\+Result\+:result\+:error\+Code\+:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) on\+Get\+Route\+Plan\+Share\+U\+R\+L\+Result\+: 
\begin{DoxyParamCaption}
\item[{({\bf B\+M\+K\+Share\+U\+R\+L\+Search} $\ast$)}]{searcher}
\item[{result:({\bf B\+M\+K\+Share\+U\+R\+L\+Result} $\ast$)}]{result}
\item[{errorCode:(B\+M\+K\+Search\+Error\+Code)}]{error}
\end{DoxyParamCaption}
\hspace{0.3cm}{\ttfamily [optional]}}\label{protocol_b_m_k_share_u_r_l_search_delegate-p_a04fa292234fc3f9cdc03917291cb9256}
返回路线规划分享url 
\begin{DoxyParams}{参数}
{\em searcher} & 搜索对象 \\
\hline
