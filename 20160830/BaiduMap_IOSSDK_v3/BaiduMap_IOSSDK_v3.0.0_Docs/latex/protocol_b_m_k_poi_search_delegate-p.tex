...
\end{DoxySeeAlso}
\hypertarget{protocol_b_m_k_poi_search_delegate-p_a01a8e8a58b7d958c66e048db693d9fe4}{}\index{B\+M\+K\+Poi\+Search\+Delegate-\/p@{B\+M\+K\+Poi\+Search\+Delegate-\/p}!on\+Get\+Poi\+Indoor\+Result\+:result\+:error\+Code\+:@{on\+Get\+Poi\+Indoor\+Result\+:result\+:error\+Code\+:}}
\index{on\+Get\+Poi\+Indoor\+Result\+:result\+:error\+Code\+:@{on\+Get\+Poi\+Indoor\+Result\+:result\+:error\+Code\+:}!B\+M\+K\+Poi\+Search\+Delegate-\/p@{B\+M\+K\+Poi\+Search\+Delegate-\/p}}
\subsubsection[{on\+Get\+Poi\+Indoor\+Result\+:result\+:error\+Code\+:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (void) on\+Get\+Poi\+Indoor\+Result\+: 
\begin{DoxyParamCaption}
\item[{({\bf B\+M\+K\+Poi\+Search} $\ast$)}]{searcher}
\item[{result:({\bf B\+M\+K\+Poi\+Indoor\+Result} $\ast$)}]{poi\+Indoor\+Result}
\item[{errorCode:(B\+M\+K\+Search\+Error\+Code)}]{error\+Code}
\end{DoxyParamCaption}
\hspace{0.3cm}{\ttfamily [optional]}}\label{protocol_b_m_k_poi_search_delegate-p_a01a8e8a58b7d958c66e048db693d9fe4}
返回\+P\+O\+I室内搜索结果 
\begin{DoxyParams}{参数}
{\em searcher} & 搜索对象 \\
\hline
{\em poi\+Indoor\+Result} & 搜索结果列表 \\
\hline
{\em error\+Code} & 错误号，\\
\hline
\end{DoxyParams}
