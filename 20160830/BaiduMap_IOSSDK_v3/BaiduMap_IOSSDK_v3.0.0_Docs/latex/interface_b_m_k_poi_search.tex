...
成功返回\+Y\+E\+S，否则返回\+N\+O 
\end{DoxyReturn}
\hypertarget{interface_b_m_k_poi_search_a44b9bffec763c9c2c1da9093cda1a906}{}\index{B\+M\+K\+Poi\+Search@{B\+M\+K\+Poi\+Search}!poi\+Indoor\+Search\+:@{poi\+Indoor\+Search\+:}}
\index{poi\+Indoor\+Search\+:@{poi\+Indoor\+Search\+:}!B\+M\+K\+Poi\+Search@{B\+M\+K\+Poi\+Search}}
\subsubsection[{poi\+Indoor\+Search\+:}]{\setlength{\rightskip}{0pt plus 5cm}-\/ (B\+O\+O\+L) poi\+Indoor\+Search\+: 
\begin{DoxyParamCaption}
\item[{({\bf B\+M\+K\+Poi\+Indoor\+Search\+Option} $\ast$)}]{option}
\end{DoxyParamCaption}
}\label{interface_b_m_k_poi_search_a44b9bffec763c9c2c1da9093cda1a906}
poi室内检索 异步函数，返回结果在\+B\+M\+K\+Poi\+Search\+Delegate的on\+Get\+Poi\+Indoor\+Result通知 
\begin{DoxyParams}{参数}
{\em option} & poi室内检索参数类（\+B\+M\+K\+Poi\+Indoor\+Search\+Option） \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{返回}
成功返回\+Y\+E\+S，否则返回\+N\+O 
